...
4. For beginners, start with a smaller model (May 2026):
   - **Qwen 3** is available in multiple sizes; the 0.6B variant (~1 GB) runs on almost any laptop
   - **Gemma 3 (4B)** is a great small all-rounder
   - **Phi-4** (Microsoft) punches well above its weight on reasoning
   - **DeepSeek R1 Distill (7B)** if you want to try a small "reasoning" model
